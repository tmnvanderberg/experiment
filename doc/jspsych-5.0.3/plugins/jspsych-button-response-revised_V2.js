...
jsPsych.plugins["button-response-revised_V2"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    //Wager Radio Options
  	trial.wager_radios = trial.wager_radios || false;
    ...
    // Add line break so there is a space between stimulus and wager radio buttons
    ...
    if (trial.wager_radios) {
      var start_wager_time = 0;
    };
    ...
    function add_wagerradios() {
        ...
        // add submit button
  	    ...
  	    $("#jspsych-survey-text-next").click(function() {
  	      ...
  	      var end_wager_time= Date.now();
  		    var response_wager_time = end_wager_time - start_wager_time;
        ...
        $("#jspsych-survey-likert-form .jspsych-survey-likert-opts").each(function(index) {
          ...
          if (response > 0){
              wager_response = true;
              wager_amount = Number(response) + 4;
            }
        });
